...
var MsgMap = map[ErrorType]string{
	...
	ErrorNotActiveUser:         "Account is not activated",
	...
	ErrorDatabaseGet:           "Get entity failed",
	ErrorDatabaseCreate:        "Create entity failed",
	ErrorDatabaseUpdate:        "Update entity failed",
	ErrorDatabaseDelete:        "Delete entity failed",
	ErrorTimeout:               "The request was timeout",
}
